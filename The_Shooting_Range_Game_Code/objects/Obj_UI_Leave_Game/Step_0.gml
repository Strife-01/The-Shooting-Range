if (rise_delay > 0) {
    ...
    // Bigger base motion
    var sway_y   = -sin(anim_time * 0.8) * 6 / 3;  // ↑ amplitude from 3 to 6, slower freq
    var sway_x   = -sin(anim_time * 0.6) * 5 / 3;  // ↑ amplitude from 2 to 5, slower freq
    var sway_rot = -sin(anim_time * 0.5) * 4 / 3;  // ↑ amplitude from 2 to 4, slower freq
